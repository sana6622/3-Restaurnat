<template>
  <main role="main">
    <div class="album py-5 bg-light">
      <div class="container">
        <UserProfileCard :initialUser="User" :currentUser="currentUser"></UserProfileCard>

        <div class="row">
          <div class="col-md-4">
            <UserFollowingsCard :followings="Followings"></UserFollowingsCard>
            <br />
            <UserFollowersCard :followers="Followers"></UserFollowersCard>
          </div>

          <div class="col-md-8">
            <UserCommentsCard :comments="Comments"></UserCommentsCard>
            <br />
            <UserFavoritedRestaurantsCard :favoritedRestaurants="FavoritedRestaurants"></UserFavoritedRestaurantsCard>
          </div>
        </div>
      </div>
    </div>
...
const dummyData = {
  'profile': {
    ...
    'isAdmin': true,
    'image': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFRoeKS6jv8OV-D9DsLLQKdkmfEvPug2vaaA&usqp=CAU',
...
export default {
  ...
  methods: {
    fetchUser () {
      ...
      const {id, name, email, isAdmin, image, createdAt,Comments,FavoritedRestaurants,Followings,Followers }=profile
        this.User = {
          id ,
          name,
          email,
          ...
          FavoritedRestaurantsNun: FavoritedRestaurants.length,
          FollowersNum: Followers.length,
          FollowingsNUm: Followings.length 
        }
